...
x9 = np.log(pd.read_csv('../input/svr_residual.csv')).pop('SalePrice') #!!!!!!!!need substitute
pd.DataFrame({'Id': test_df["Id"], 'SalePrice': np.exp((x8+x9)/2)}).to_csv('x8x9.csv', index =False)